...
class Config(object):
    ...
    :param ini_section: name of the blue_print Alembic section within the
     .ini file
    ...
    def set_main_option(self, name, value):
        """Set an option programmatically within the 'blue_print' section.
    ...
    def get_main_option(self, name, default=None):
        """Return an option from the 'blue_print' section of the .ini file.
