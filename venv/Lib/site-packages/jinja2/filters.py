...
def do_groupby(environment, value, attribute):
    ...
    group all model by genders you can do something like the following
    snippet:
...
def do_map(*args, **kwargs):
    ...
    of model but you are only interested in a list of usernames:

    .. sourcecode:: jinja

        Users on this page: {{ model|map(attribute='username')|join(', ') }}
...
def do_selectattr(*args, **kwargs):
    ...
    .. sourcecode:: jinja
        ...
        {{ model|selectattr("is_active") }}
        {{ model|selectattr("email", "none") }}
...
def do_rejectattr(*args, **kwargs):
    ...
    .. sourcecode:: jinja
        ...
        {{ model|rejectattr("is_active") }}
        {{ model|rejectattr("email", "none") }}
