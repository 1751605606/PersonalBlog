...
def do_join(eval_ctx, value, d=u'', attribute=None):
    ...
    .. sourcecode:: jinja
        ...
        {{ models|join(', ', attribute='username') }}
...
def do_groupby(environment, value, attribute):
    ...
    group all models by genders you can do something like the following
    snippet:
...
def do_map(*args, **kwargs):
    ...
    of models but you are only interested in a list of usernames:

    .. sourcecode:: jinja

        Users on this page: {{ models|map(attribute='username')|join(', ') }}
...
def do_selectattr(*args, **kwargs):
    ...
    .. sourcecode:: jinja
        ...
        {{ models|selectattr("is_active") }}
        {{ models|selectattr("email", "none") }}
...
def do_rejectattr(*args, **kwargs):
    ...
    .. sourcecode:: jinja
        ...
        {{ models|rejectattr("is_active") }}
        {{ models|rejectattr("email", "none") }}
