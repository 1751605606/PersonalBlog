    ...
    def values(self, *args, **kwargs):
        ...
        :param \**kwargs: key value pairs representing the string key
          ...
          VALUES or SET clause::
                ...
                models.insert().values(name="some name")

                models.update().where(models.c.id==5).values(name="some name")
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         the kwargs form::
            ...
            models.update().values({"name": "some new name"})
         ...
         table is also accepted::
            ...
            models.insert().values((5, "some name"))
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        E.g.::
            ...
            stmt = update(models).where(models.c.id==5).\
                    values(name='user #5')
        ...
        :param whereclause: Optional SQL expression describing the ``WHERE``
         ...
         subquery::
            ...
            models.update().values(name='ed').where(
                    models.c.name==select([addresses.c.email_address]).\
                                where(addresses.c.user_id==models.c.id).\
                                as_scalar()
                    )
