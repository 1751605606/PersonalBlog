...
class TextClause(Executable, ClauseElement):
    ...
    def _create_text(
        ...
        E.g.::
            ...
            t = text("SELECT * FROM models WHERE id=:user_id")
            result = connection.execute(t, user_id=12)

        For SQL statements where a colon is required verbatim, as within
        an inline string, use a backslash to escape::

            t = text("SELECT * FROM models WHERE name='\:username'")
        ...
        such as for the WHERE clause of a SELECT statement::
            ...
            s = select([models.c.id, models.c.name]).where(text("id=:user_id"))
    ...
    def columns(self, selectable, *cols, **types):
        ...
        name or origin of the column in the textual SQL doesn't matter::
            ...
            stmt = text("SELECT models.id, addresses.id, models.id, "
                 "models.name, addresses.email_address AS email "
                 "FROM models JOIN addresses ON models.id=addresses.user_id "
                 "WHERE models.id = 1").columns(
                    User.id,
                    Address.id,
                    Address.user_id,
                    User.name,
